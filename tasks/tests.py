...
class TaskListTests(APITestCase):
    ...
    def test_task_ownership_on_creation(self):
        '''
        Ensure that the owner of a newly created task
    ...
    def test_cannot_update_owner_field(self):
        '''
        Ensure users cannot change ownership.
        Other fields will still be updated.
        '''
        self.client.login(username='testuser1', password='password123')
        ...
        self.assertEqual(
            self.task1.description, "Trying to change the owner field."
            )
    ...
    def test_unauthorized_task_update(self):
        ...
        self.assertNotEqual(
            self.task1.description, "This should not be allowed"
            )
    ...
    def test_update_non_existent_task(self):
        '''
        Ensure that attempting to update
        a non-existent task returns 404 Not Found.
        '''
        self.client.login(username='testuser1', password='password123')
        non_existent_task_id = 9999
        update_data = {
...
class TaskFilteringTests(APITestCase):
    ...
    def test_filter_by_status_valid(self):
        '''
        Users can filter tasks by valid status
